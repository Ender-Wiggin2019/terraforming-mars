    ...
    super({
      ...
      metadata: {
        ...
        renderData: CardRenderer.builder((b) => {
          b.br;
          b.megacredits(42).nbsp.building(1, {played}).colon().animals(1).br;
          b.text('(Action: When you play a card with a building or city tag, add 1 animal on this card.)', Size.SMALL, false, false).br;
          b.effect('When you have 3 animals, automatically convert to 3 steel and draw 1 card.', (eb) => {
            eb.text('3').animals(1).asterix().startAction.steel(3, {digit}).cards(1);
          }).br;
        }),
      },
    });
